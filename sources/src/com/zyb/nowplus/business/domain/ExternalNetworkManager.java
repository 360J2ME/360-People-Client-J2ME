...
public interface ExternalNetworkManager 
{
	/**
	 * Indicates if the manager has a list of external networks.
	...
	/**
	 * Finds an external network by id.
	 */
	public ExternalNetwork findNetworkById(String networkId);
	
	/**
	 * Indexes an account on a network for a profile.
	 */
