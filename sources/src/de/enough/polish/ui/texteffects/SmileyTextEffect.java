...
public class SmileyTextEffect extends TextEffect {
	...
	/*
	 * This is for fixing bug#16103: Chat : in case of new line some smileys are not placed correctly
	 * {@link http://mantis.next-vodafone.com/mantis/view.php?id=16103}
	 * {@linkhttp://mantis.next-vodafone.com/mantis/file_download.php?file_id=7883&type=bug}
	 *  
	 * TODO contact with j2mepolish to fix this or find better way 
	 * 
	 * called from class StringItem {@link de.enough.polish.ui.StringItem#wrap(java.lang.String,int,int)}#line826
	 * 
	 * @see de.enough.polish.ui.TextEffect#wrap(de.enough.polish.ui.Item, java.lang.String, int, de.enough.polish.blackberry.ui.Font, int, int, int, java.lang.String, int)
	 */
